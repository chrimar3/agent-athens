...
export const ENRICHMENT_MATRIX: Record<EventCategory, MatrixEntry> = {
  exhibition:           { min: 200, max: 300, structure: 'hybrid' },
  concert_major:        { min: 120, max: 200, structure: 'hybrid' },
  concert_local:        { min: 80,  max: 120, structure: 'three-part-block' },
  kids_family:          { min: 120, max: 180, structure: 'hybrid' },
  festival_parent:      { min: 250, max: 400, structure: 'full-8-section' },
  festival_sub:         { min: 80,  max: 150, structure: 'three-part-block' },
  theater_ancient:      { min: 180, max: 250, structure: 'hybrid' },
  theater_contemporary: { min: 120, max: 180, structure: 'hybrid' },
  premium_showcase:     { min: 400, max: 600, structure: 'full-8-section' },
  default:              { min: 120, max: 200, structure: 'hybrid' },
};
