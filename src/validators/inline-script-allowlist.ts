...
export const INLINE_SCRIPT_ALLOWLIST: ReadonlyArray<{ sha256: string; source: string }> = [
  ...
  { sha256: '11abd0762084fba2e82191a044c256c6cce11f141fad2ab19dfa9de549ccbfeb', source: "src/templates/search-overlay.ts renderSearchScript('el')" },
  { sha256: '1710ac2492bd57db8231beeeb485da0fe902aef374df44d09dcd621236068829', source: "src/templates/search-overlay.ts renderSearchScript('en')" },
