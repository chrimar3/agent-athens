...
### Η ΑΝΑΤΟΜΙΑ ΤΗΣ ΑΠΟΛΑΥΣΗΣ
- **ID**: 6ac179a46896de3a
- **Type**: theater
- **Venue**: Σκηνή BRECHT - 2510
- **Price**: paid
- **Date**: 2026-02-28
- **Time**: 21:00
- **URL**: https://www.more.com/gr-el/tickets/theater/i-anatomia-tis-apolausis/
- **Source**: more.com
- **Venue intel**: Not in database. WebSearch "Σκηνή BRECHT - 2510 Athens" for context.
...
- **Date**: 2026-02-28
- **Time**: 20:00
- **URL**: https://www.athinorama.gr/music/gig/human_touch-10017239/
- **Source**: athinorama.gr
- **Venue intel**: Not in database. WebSearch "Jazzet Cafe Athens" for context.
...
- **Time**: 21:00
- **URL**: https://ra.co/events/2367430
- **Source**: residentadvisor
- **Venue intel**: Not in database. WebSearch "Mona Athens Athens" for context.
...
- **Date**: 2026-02-28
- **Time**: 21:15
- **URL**: https://www.more.com/gr-el/tickets/theater/xasame-ti-theia-stop/
- **Source**: more.com
- **Venue intel**: Not in database. WebSearch "Φιλίπ Athens" for context.

### The Stroryville Ragtimers
- **ID**: bc749a0c51694263
- **Type**: concert
- **Venue**: Ορφέας Cafe Bar
- **Price**: paid
- **Date**: 2026-02-28
- **Time**: 21:30
- **URL**: https://www.athinorama.gr/music/gig/the_stroryville_ragtimers_-10079151/
- **Source**: athinorama.gr
- **Venue intel**: Not in database. WebSearch "Ορφέας Cafe Bar Athens" for context.
...
5. **Save decision** (after completing ALL events in this batch):
   ...
   ```bash
   bun run scripts/save-batch.ts --session=batch-30 --batch=30
   ```
   Note "AUTO-SAVED" at the top of batch-30-review.md.
   - If ANY score is < 85 OR any have errors: do NOT run save-batch.ts.
     Note "LEFT FOR REVIEW" at the top of batch-30-review.md with reasons.

After all events, create `temp-descriptions/batch-30-review.md` with:

| Event ID | Title | Gate Score | Issues | Confidence |
|----------|-------|------------|--------|------------|
| 6ac179a46896de3a | Η ΑΝΑΤΟΜΙΑ ΤΗΣ ΑΠΟΛΑΥΣΗΣ | /100 | | |
| 0a9c257425188990 | Human Touch | /100 | | |
| de4acc79c181b029 | Purim Athens | /100 | | |
| 9308c02a8ab86b65 | ΧΑΣΑΜΕ ΤΗ ΘΕΙΑ ΣΤΟΠ | /100 | | |
| bc749a0c51694263 | The Stroryville Ragtimers | /100 | | |
