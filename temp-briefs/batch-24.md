...
### Adrianos Papadeas + Maria Papidaki
- **ID**: 81eeab9b45b5ca53
- **Type**: dj_set
- **Venue**: Boo!
- **Price**: door
...
- **Time**: 21:00
- **URL**: https://www.clubber.gr/events/adrianos-papadeas-maria-papidaki-2/
- **Source**: clubber.gr
...
- **Venue**: Μέγαρο Μουσικής Αθηνών
- **Price**: with-ticket
- **Date**: 2026-03-18T20:30:00+03:00
- **Time**: 20:30
- **URL**: https://www.megaron.gr/event/chamber-orchestra-of-europe-2/
- **Source**: megaron.gr
- **Venue intel**: Not in database. WebSearch "Μέγαρο Μουσικής Αθηνών Athens" for context.
...
5. **Save decision** (after completing ALL events in this batch):
   ...
   ```bash
   bun run scripts/save-batch.ts --session=batch-24 --batch=24
   ```
   Note "AUTO-SAVED" at the top of batch-24-review.md.
   - If ANY score is < 85 OR any have errors: do NOT run save-batch.ts.
     Note "LEFT FOR REVIEW" at the top of batch-24-review.md with reasons.

After all events, create `temp-descriptions/batch-24-review.md` with:

| Event ID | Title | Gate Score | Issues | Confidence |
|----------|-------|------------|--------|------------|
| 6a43965cb88de08c | Οδύσσεια | /100 | | |
| 4e3c5ef91ec54dd7 | Το μαγικό εισιτήριο | /100 | | |
| 81eeab9b45b5ca53 | Adrianos Papadeas + Maria Papidaki | /100 | | |
| 1f26655c508234e8 | Chamber Orchestra of Europe | /100 | | |
| 080cfa121ea8cef0 | Ρωμαίος και Ιουλιέτα… σαν το σκύλο με τη γάτα | /100 | | |
