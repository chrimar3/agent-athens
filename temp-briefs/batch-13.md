...
- **Date**: 2026-02-27
- **Time**: 21:00
- **URL**: https://www.athinorama.gr/music/gig/mora_sti_fotia-10050651/
- **Source**: athinorama.gr
...
- **Time**: 22:00
- **URL**: https://ra.co/events/2379024
...
- **Date**: 2026-03-07
- **Time**: 20:30
- **URL**: https://www.athinorama.gr/music/gig/ethniki_sumfoniki_orxistra_ert-10063973/
- **Source**: athinorama.gr
...
5. **Save decision** (after completing ALL events in this batch):
   ...
   ```bash
   bun run scripts/save-batch.ts --session=batch-13 --batch=13
   ```
   Note "AUTO-SAVED" at the top of batch-13-review.md.
   - If ANY score is < 85 OR any have errors: do NOT run save-batch.ts.
     Note "LEFT FOR REVIEW" at the top of batch-13-review.md with reasons.

After all events, create `temp-descriptions/batch-13-review.md` with:

| Event ID | Title | Gate Score | Issues | Confidence |
|----------|-------|------------|--------|------------|
| 8380378e9e5246a7 | Ο Του-του και η Τσαφ-τσουφ | /100 | | |
| b4cd5ccee9adc7d3 | Μωρά στη φωτιά | /100 | | |
| 6abdcdb729abcf08 | Bonso / Roussos | /100 | | |
| 5e5e914199c3fc33 | Εθνική Συμφωνική Ορχήστρα ΕΡΤ | /100 | | |
| 4d0ccbf202207e72 | In motion: Ένα άγαλμα που το ’σκασε | /100 | | |
