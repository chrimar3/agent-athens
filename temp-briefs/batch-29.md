...
- **Price**: paid
- **Date**: 2026-02-28
- **URL**: https://www.more.com/gr-el/tickets/theater/rodafnon/
- **Source**: more.com
- **Venue intel**: Not in database. WebSearch "Από Μηχανής Θέατρο Athens" for context.
...
- **Date**: 2026-02-28
- **Time**: 21:00
- **URL**: https://www.athinorama.gr/music/gig/kumides_-10089218/
- **Source**: athinorama.gr
- **Venue intel**: Not in database. WebSearch "Πολυχώρος Διέλευσις Athens" for context.

### Xtracavanza: DJ Taf // afterhours: Sunshine Pedro + Bellas
- **ID**: e05375bbf2dbf4e6
- **Type**: dj_set
...
- **Time**: 20:00
- **URL**: https://www.clubber.gr/events/xtracavanza-dj-taf-afterhours-sunshine-pedro-bellas-2/
- **Source**: clubber.gr
...
- **Date**: 2026-02-28
- **Time**: 18:00
- **URL**: https://www.more.com/gr-el/tickets/theater/ilios-me-dontia/
- **Source**: more.com
- **Venue intel**: Not in database. WebSearch "Θέατρο Μπέλλος Athens" for context.

### The Greek Jazz Book Concert #1
- **ID**: 60748af924c56ecc
- **Type**: concert
...
- **Date**: 2026-02-28
- **Time**: 21:00
- **URL**: https://www.athinorama.gr/music/gig/the_greek_jazz_book_concert_1-10089222/
- **Source**: athinorama.gr
...
5. **Save decision** (after completing ALL events in this batch):
   ...
   ```bash
   bun run scripts/save-batch.ts --session=batch-29 --batch=29
   ```
   Note "AUTO-SAVED" at the top of batch-29-review.md.
   - If ANY score is < 85 OR any have errors: do NOT run save-batch.ts.
     Note "LEFT FOR REVIEW" at the top of batch-29-review.md with reasons.

After all events, create `temp-descriptions/batch-29-review.md` with:

| Event ID | Title | Gate Score | Issues | Confidence |
|----------|-------|------------|--------|------------|
| 560cdafb7aae4595 | Ροδάφ'νον | /100 | | |
| e504d6ff975e7248 | Κύμηδες | /100 | | |
| e05375bbf2dbf4e6 | Xtracavanza: DJ Taf // afterhours: Sunshine Pedro + Bellas | /100 | | |
| 0a170dcfabd30329 | Ήλιος με δόντια | /100 | | |
| 60748af924c56ecc | The Greek Jazz Book Concert #1 | /100 | | |
