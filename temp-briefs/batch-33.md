...
- **Price**: paid
- **Date**: 2026-02-28
- **URL**: https://www.more.com/gr-el/tickets/music/miltos-pasxalidis-stauros-tou-notou-3/
- **Source**: more.com
- **Venue intel**: Not in database. WebSearch "Σταυρός του Νότου Athens" for context.

### Marthe at Daddy'S all day bar
- **ID**: e516754be6080f47
- **Type**: dj_set
...
- **Time**: 21:30
- **URL**: https://ra.co/events/2378138
...
5. **Save decision** (after completing ALL events in this batch):
   ...
   ```bash
   bun run scripts/save-batch.ts --session=batch-33 --batch=33
   ```
   Note "AUTO-SAVED" at the top of batch-33-review.md.
   - If ANY score is < 85 OR any have errors: do NOT run save-batch.ts.
     Note "LEFT FOR REVIEW" at the top of batch-33-review.md with reasons.

After all events, create `temp-descriptions/batch-33-review.md` with:

| Event ID | Title | Gate Score | Issues | Confidence |
|----------|-------|------------|--------|------------|
| 0a9bcd1fea6317f7 | Το ταξίδι της Σοφίας στις 4 εποχές | /100 | | |
| a72d5c4949673ea0 | ΜΙΛΤΟΣ ΠΑΣΧΑΛΙΔΗΣ | /100 | | |
| e516754be6080f47 | Marthe at Daddy'S all day bar | /100 | | |
| 8af1af65ef00df06 | Χίλιοι λόγοι για να τσακωθείς | /100 | | |
| a92547a3db081af2 | Το μαγικό εισιτήριο | /100 | | |
